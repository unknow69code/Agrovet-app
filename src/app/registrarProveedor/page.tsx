...
function RegisterProvedores() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      enqueueSnackbar('Proveedor registrado exitosamente.', { variant: 'success', });
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-12">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-10 shadow-xl">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-gray-500">Bienvenido a este sistema, a continuacion puedes registrar un Proveedor.</p>
        </div>
