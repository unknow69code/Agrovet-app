...
import { CheckCircle, IdCard, MapPinHouse, PhoneIcon, UserIcon } from "lucide-react";
...
function RegisterClient() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      enqueueSnackbar("Cliente registrado exitosamente.", {
        variant: "success",
      });
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-10 shadow-xl">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="relative">
              <MapPinHouse className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
              <input
                id="address"
                name="address"
                type="text"
